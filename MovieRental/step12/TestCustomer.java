...
public class TestCustomer extends TestCase {
	...
	public void testHtmlStatement1() {
		
			String htmlAdams = "<H1>Rental Record for Adams</H1>\n<TABLE BORDER=\"1\">\n<TR><TH>Days<TH>Title<TH>Charge\n<TR><TD>3<TD>Jaws<TD>3.5\n<TR><TD>2<TD>Fantasia 2000<TD>1.5\n<TR><TD>1<TD>X Men<TD>3.0\n</TABLE>\n<P>Amount owed is <B>8.0</B></P>\n<P>You earned <B>3</B> frequent renter points</P>\n";

  	  	    adams.addRental(new Rental(TestMovie.m2r, 3));
  	  	    adams.addRental(new Rental(TestMovie.m4c, 2));
  	  	    adams.addRental(new Rental(TestMovie.m6n, 1));
  	  	    
  	  	    Assert.assertTrue(adams.htmlStatement().equals(htmlAdams));
  	  	    }  	  	    
